...
import type { IEnrollmentRepository } from '../../application/ports.js';
import type { IEventStore } from '../event-store/interfaces.js';
import { EventStreamFactory } from '../event-store/event-stream.js';
import { reconstructEnrollmentFromEvents } from '../../domain/enrollment-aggregate.js';
